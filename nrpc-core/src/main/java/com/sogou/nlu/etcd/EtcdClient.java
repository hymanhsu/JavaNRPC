...
public class EtcdClient implements Closeable {
    ...
    private ExecutorService delegateAsyncTransformer = null;
    private ListeningExecutorService transformerPool = null;
    ...
    public EtcdClient(URI uri) {
        ...
        this.delegateAsyncTransformer = Executors.newFixedThreadPool(1,new DaemonThreadFactory());
        this.transformerPool = MoreExecutors.listeningDecorator(delegateAsyncTransformer);
    }

    public EtcdClient(String etcdIp, int etcdPort){
        this(URI.create("http://"+etcdIp+":"+etcdPort+"/"));
    }
    ...
    public void close() throws IOException {
        ...
        if(delegateAsyncTransformer != null){
            delegateAsyncTransformer.shutdown();
        }
    }
